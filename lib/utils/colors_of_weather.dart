...
abstract class ColorsWeather {
  ...
  static Color clearDay = const Color(0xFF00BFFF);
  static Color snowDay = const Color(0xFFB0C4DE);
  static Color cloudyNight = const Color(0xFF483D8B);
  static Color rainyNight = const Color(0xFF4B0082);
